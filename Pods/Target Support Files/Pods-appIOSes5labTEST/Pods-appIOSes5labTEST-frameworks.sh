...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/SparkSDK/Frameworks/Sbu.framework"
  install_framework "${PODS_ROOT}/SparkSDK/Frameworks/Seu.framework"
  install_framework "${PODS_ROOT}/SparkSDK/Frameworks/Wme.framework"
